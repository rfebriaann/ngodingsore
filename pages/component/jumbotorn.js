  ...
  return (
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute z-10 bottom-0 right-0 px-32 py-10">
        <Image src="/logo/logo-horizontal.png" width={50} height={50} />
      </div> */}
